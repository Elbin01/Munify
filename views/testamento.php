...
<head>
  ...
  <title>Testamento - Registro del Estado Familiar</title>
...
<div class="hoja">
  ...
  <div class="cuerpo">
      ...
      <div class="card-body">
        <div class="campos">
          <div class="campo full">
            ...
            <div class="valor"><?= htmlspecialchars($datos_testador['nombre']) ?></div>
          </div>
          <div class="campo">
            <label>DUI</label>
            <div class="valor"><?= htmlspecialchars($datos_testador['dui']) ?></div>
          </div>
          <div class="campo">
            <label>Edad</label>
            <div class="valor"><?= !empty($datos_testador['edad']) ? htmlspecialchars($datos_testador['edad']) . ' Años' : '' ?></div>
          </div>
          <div class="campo">
            <label>Estado Civil</label>
            <div class="valor"><?= htmlspecialchars($datos_testador['estado_civil']) ?></div>
          </div>
          <div class="campo full">
            <label>Domicilio</label>
            <div class="valor"><?= htmlspecialchars($datos_testador['domicilio']) ?></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-header">Herederos y Beneficiarios</div>
      <div class="card-body">
        <div class="campos">
          <div class="campo full">
            <label>Nombre del heredero principal</label>
            <div class="valor"><?= htmlspecialchars($datos_herederos['heredero']) ?></div>
          </div>
          <div class="campo full">
            <label>Parentesco / Relación de afinidad</label>
            <div class="valor"><?= htmlspecialchars($datos_herederos['parentesco']) ?></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="campos">
          <div class="campo full">
            <label>Descripción del patrimonio patrimonial</label>
            <div class="valor" style="white-space: pre-line;"><?= htmlspecialchars($datos_acto['bienes']) ?></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="campos">
          <div class="campo full">
            <label>Voluntad Testamentaria / Disposiciones Especiales</label>
            <div class="valor" style="white-space: pre-line;"><?= htmlspecialchars($datos_acto['declaracion']) ?></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="firmas">
      <div class="firma-bloque">
        ...
        <div class="firma-titulo">Firma del Testador / Otorgante</div>
        <div class="firma-nombre"><?= htmlspecialchars($datos_footer['testador']) ?></div>
      </div>
      <div class="firma-bloque">
        <div class="firma-linea"></div>
...
</div><button class="btn-imprimir" onclick="confirmarImpresion()">
   🖨️ Imprimir
</button>
...
function confirmarImpresion(){
    Swal.fire({
        title: '¿Imprimir Testamento?',
        text: 'Verifique que toda la información del otorgante sea legal y correcta.',
        icon: 'question',
