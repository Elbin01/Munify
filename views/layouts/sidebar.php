<div class="d-flex flex-column flex-shrink-0 p-3 custom-sidebar" style="width: 280px; height: 100vh;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
            <a href="SolicitudCitas.php" class="nav-link text-white">
                <i class="bi bi-calendar-check me-2"></i>
                Citas
            </a>
        </li>
        <li>
            <a href="Carnet minoridad.php" class="nav-link text-white">
                <i class="bi bi-person-badge me-2"></i>
                Carnet Minoridad
            </a>
        </li>
        <li>
            <a href="CartaDefuncion.php" class="nav-link text-white">
                <i class="bi bi-file-earmark-x me-2"></i>
                Carta de Defunción
            </a>
        </li>
        <li>
            <a href="recepcion_partida.php" class="nav-link text-white">
